...
<div class=\"card shadow-sm\">
    ...
    <div class=\"card-body\">
        ...
        echo "\" class=\"btn btn-sm btn-outline-secondary\">View</a>
                <a href=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("edit_view", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 15, $this->source); })()), "id", [], "any", false, false, false, 15)]), "html", null, true);
        echo "\" class=\"btn btn-sm btn-outline-secondary\">Edit</a>
            ...
            <small class=\"text-muted\">
                ";
        // line 19
        echo twig_escape_filter($this->env, (isset($context["randomMin"]) || array_key_exists("randomMin", $context) ? $context["randomMin"] : (function () { throw new RuntimeError('Variable "randomMin" does not exist.', 19, $this->source); })()), "html", null, true);
        echo "
            </small>
        </div>
    </div>
    ...
    <div class=\"card-body\">
        ...
        <div class=\"d-flex justify-content-between align-items-center\">
            <div class=\"btn-group\">
                ...
                <a href=\"{{ path('edit_view', {id: article.id}) }}\" class=\"btn btn-sm btn-outline-secondary\">Edit</a>
            </div>
