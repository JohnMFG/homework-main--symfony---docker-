...
class __TwigTemplate_55284c7ccf541db2503409beda63125e extends Template
{
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        // line 9
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("edit_view", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 9, $this->source); })()), "id", [], "any", false, false, false, 9)]), "html", null, true);
        echo "\">
                    ";
        // line 10
        ...
        echo "
                    ";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "image", [], "any", false, false, false, 12), 'widget');
        echo "
                    ";
        // line 13
    ...
    {
        return array (  120 => 30,  114 => 27,  109 => 25,  102 => 21,  96 => 17,  92 => 15,  88 => 14,  84 => 13,  80 => 12,  76 => 11,  72 => 10,  68 => 9,  62 => 5,  59 => 4,  52 => 3,  35 => 1,);
    }
    ...
    {% block main %}
        ...
        <main>
            <div class=\"py-5 bg-light\">
                ...
                <form method=\"POST\" action=\"{{ path('edit_view', {id: article.id}) }}\">
                    {{ form_start(form) }}
